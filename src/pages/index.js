  ...
  return (
    <>
      ...
      <title>TravelApp 🤔</title>
        ...
        <meta name="description" content="Find the best places in the world !!!" />
      ...
      <main className="dark:bg-darkModeColor">
        ...
        <section id="stays" className="mt-5 p-5 sm:p-1">
          <h2 className="ml-5 sm:ml-0 mb-5 text-h2Size text-version1 font-bold">
            Trending Stays
          </h2>

          <div className="flex gap-4 flex-wrap">
            <div className="relative z-0 h-2 min-h-[500px] w-full min-w-[320px]  rounded-3xl">
              <div className="absolute z-10 p-5 flex flex-col w-[95%] justify-end">
                <h2 className="text-h2Size text-white font-bold text-end">
                  Chicago
                </h2>
            ...
            <div className="relative z-0 h-2 min-h-[500px] w-[37%] md:w-full rounded-3xl">
              <div className="absolute z-10 p-5 flex flex-col w-[95%] justify-end items-end">
                <h2 className="text-h2Size text-white font-bold text-end">
                  LA
                </h2>
                <p className="text-end text-white w-40">
            ...
            <div className="flex flex-col w-[60%] md:w-full gap-5">
              <div className="relative z-0 h-2 min-h-[240px] md:min-h-[500px] md:w-full rounded-3xl">
                <div className="absolute z-10 p-5 flex flex-col w-[95%] justify-end items-end">
                  ...
                  <p className="text-end text-white w-60">
